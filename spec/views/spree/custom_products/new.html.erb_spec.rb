...
describe "spree/custom_products/new" do
  before(:each) do
    assign(:spree_custom_product, stub_model(Spree::CustomProduct,
      :name => "MyString",
  ...
  it "renders new spree_custom_product form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", spree_custom_products_path, "post" do
